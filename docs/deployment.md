...
Linc can run in a container, but free hosting is a rough fit for a browser-based scraper. Chromium needs more memory and CPU than a small static site or basic Flask app.
